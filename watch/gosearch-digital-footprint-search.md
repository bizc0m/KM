# GoSearch - Digital Footprint Search

## Type

Veille `#ROUGE` / recherche OSINT de profils.
...
Garder en veille `#ROUGE` interne, meta uniquement.

## Changelog

### v0.1 - 2026-06-24

- Objectif : integrer GoSearch depuis Raindrop KM Monitor.
- Fichiers touches : `watch/gosearch-digital-footprint-search.md`, `watch/index.md`, `watch/red-team-risk-tools-watch.md`, `index.md`, `km/history.md`.
