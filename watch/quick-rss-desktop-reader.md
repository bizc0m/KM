...
#rss, #macos, #desktop-app, #knowledge-management, #actif

## Appel canonique

`watch:quick-rss-desktop-reader`
...
Application desktop macOS pour lire et organiser des flux RSS dans une interface locale et simple.

## Usage KM

Tester comme client RSS local pour suivre des sources publiques sans dependance a un service SaaS centralise.
