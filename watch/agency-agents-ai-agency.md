...
Veille Raindrop KM Monitor / bibliotheque d'agents IA specialises.
...
- depot : `msitarzewski/agency-agents`
- licence : MIT
...
- Objectif : integrer le nouveau signal Agency Agents depuis Raindrop KM Monitor.
- Fichiers touches : `watch/agency-agents-ai-agency.md`, `watch/index.md`, `index.md`, `km/history.md`.
- Risques : agents pre-packages, publication automatisee et prompts externes a auditer.
