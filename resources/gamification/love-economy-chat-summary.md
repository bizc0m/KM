# Love Economy Gamification - Chat Summary
...
`resource:gamification/love-economy-chat-summary`

## Usage

Servir de base aux futures specs de gamification NightIntel autour d'une economie interne non pay-to-win, ou la valeur principale vient des actions de care, de presence, de cooperation et de reputation.
...
- Gamification & Aura.
- Economie interne.
- Coordination agents et memoire produit.
...
- Ne pas permettre l'achat direct de Reputation, Aura, Karma ou influence sociale.
- Eviter les boucles exploitables par farm, multi-comptes, faux altruisme ou presence simulee.
- Garder les bonus de geolocalisation opt-in, minimises et non intrusifs.
- Ne jamais rendre publics les actes de soutien d'une maniere qui encourage la vantardise.
- Prevoir des plafonds, decay, audits et signaux anti-abus avant implementation.

## Risques

- Confusion entre monnaie interne et argent reel.
- Derive pay-to-win si les achats externes influencent directement les scores.
- Exploitation des bonus de presence ou de geolocalisation.
- Mecanique trop morale ou trop naive si le care est presente comme injonction.
- Inflation des recompenses si les paliers ne sont pas modelises.
