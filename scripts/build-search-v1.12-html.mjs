...
function sourceLinks(item){return (item.github?'<a class="tag github-link" href="'+esc(item.github)+'" target="_blank" rel="noopener noreferrer">GitHub source</a>':"")+(item.sourceUrl?'<a class="tag" href="'+esc(item.sourceUrl)+'" target="_blank" rel="noopener noreferrer">Source</a>':"")}
